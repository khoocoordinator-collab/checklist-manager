...
class TemplateItemSerializer(serializers.ModelSerializer):
    class Meta:
        model = TemplateItem
        fields = ['id', 'text', 'order', 'is_required', 'response_type', 'auto_flag_rules']
...
class InstanceItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = InstanceItem
        fields = ['id', 'template_item_id', 'item_text', 'response_type', 'response_value', 'is_checked', 'checked_at', 'photo', 'photo_url', 'photo_uploaded_at', 'current_flag', 'supervisor_confirmed', 'supervisor_comment', 'auto_flag_rules']
        read_only_fields = ['photo', 'supervisor_confirmed', 'supervisor_comment', 'auto_flag_rules']
